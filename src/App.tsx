...
function App() {
  ...
  return (
    <>
      ...
      <div className="relative flex h-full flex-col justify-center bg-background px-5 pt-5 text-primary transition-all duration-300 dark:bg-background dark:text-primary md:flex-row md:space-x-12 lg:space-x-24 xl:space-x-36">
